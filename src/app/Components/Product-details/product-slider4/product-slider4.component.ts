...
@Component({
  selector: 'app-product-slider4',
  imports: [NgFor, RouterLink],
  templateUrl: './product-slider4.component.html',
  styleUrl: './product-slider4.component.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class ProductSlider4Component implements AfterViewInit, OnDestroy{
